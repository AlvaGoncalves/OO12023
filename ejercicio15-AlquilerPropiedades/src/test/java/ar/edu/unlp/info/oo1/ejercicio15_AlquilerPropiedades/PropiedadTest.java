...
class PropiedadTest {
	...
	void setUp() throws Exception {
		...
		this.propiedad1 = new Propiedad ("Propiedad1", "abc", 500, propietario1, "Avenida Siempre Viva 742");
		this.propiedad2 = new Propiedad ("Propiedad2", "bca" , 200, propietario1, "Avenida San Martin 421" );
