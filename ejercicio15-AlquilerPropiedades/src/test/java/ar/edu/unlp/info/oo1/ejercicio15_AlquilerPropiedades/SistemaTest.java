...
class SistemaTest {
	...
	void setUp() throws Exception {
		...
		this.propiedad1 = this.sistema.registrarPropiedad("Propiedad1", "abc" , 500, propietario1, "Avenida Siempre Viva 742");
		this.propiedad2 = this.sistema.registrarPropiedad("Propiedad2", "bca" , 200, propietario1, "Avenida San Martin 421");
