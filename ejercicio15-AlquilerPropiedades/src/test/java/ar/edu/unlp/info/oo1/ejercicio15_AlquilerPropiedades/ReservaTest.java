...
class ReservaTest {
	...
	void setUp() throws Exception {
		...
		this.propiedad1 = new Propiedad ("Propiedad1", "abc" , 500, new Usuario ("Lana", "Dir", "333"), "Avenida Siempre Viva 742");
		this.propiedad2 = new Propiedad ("Propiedad2", "bca" , 0, new Usuario ("Madonna", "Dir", "222"), "Avenida San Martin 421");
